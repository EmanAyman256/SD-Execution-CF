...
export class AuthService {
  ...
  private authUrl = "https://proxy-server-app.cfapps.eu10-004.hana.ondemand.com/auth"
  private registerUrl = "https://proxy-server-app.cfapps.eu10-004.hana.ondemand.com/api/iasusers"
